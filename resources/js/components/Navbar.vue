                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="hidden lg:block">
                        <ul class="flex items-center md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 ">
                            ...
                            <li class="">
                                <a href="#" class="block py-2 pr-4 pl-3 text-black font-bold rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0"> 
                ...
                <div class="flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div class="mid-nav justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                        <ul class="flex flex-col items-center md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 ">
                            ...
                            <li class="mb-2" v-if="currentUser.slug">
...
export default{
    ...
    data(){
        return{
            ...
            tags:[],
            currentUser:{
                slug: document.querySelector("meta[name='user-slug']").getAttribute('content'),
                image: document.querySelector("meta[name='user-img']").getAttribute('content'),
            }
        }
    },
    watch:{
