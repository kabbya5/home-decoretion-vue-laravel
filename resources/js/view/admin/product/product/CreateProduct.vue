<template>
    <div class="my-10">
        ...
        <div class="header flex justify-between items-center">
            ...
            <button class="px-4 py-1 bg-cyan-500 text-white rounded-lg transiton duration-300 capitalize hover:bg-cyan-600"> all products</button>
        </div>
                ...
                <div class="grid grid-cols-12 gap-4">
                    <div class="col-span-4">
                        ...
                        <div class="flex my-4 items-center">
                            <input type="checkbox" v-model="product.free_shipping" id="free_shipping">
                            <label for="free_shipping" class="px-4 font-bold text-slate-600 capitalize"> Free shipping </label>
                        </div>
                        <div class="flex my-4 items-center">
                            <input type="checkbox" v-model="product.top_rated" id="top_rated">
                            <label for="top_rated" class="px-4 font-bold text-slate-600 capitalize">top rated </label>
                        </div>
                        <div class="flex my-4 items-center">
                            <input type="checkbox" v-model="product.week_sale" id="week_sale">
                            <label for="week_sale" class="px-4 font-bold text-slate-600 capitalize">week sale </label>
                        </div>
                    </div>
                    <div class="col-span-8">
                        ...
                        <div class="flex flex-col my-2">
                            ...
                            <p v-if="errors.imgs" class="text-red-500"> {{ errors.imgs[0] }}</p>
                        </div>
                        ...
                        <div class="flex  items-center my-4">
                            <div class="flex flex-col w-full">
                                ...
                                <input type="text" v-model="product.regular_price" placeholder="regular-price"
                                class="px-2 py-2 border-2 border-gray-200 focus:outline-none"
                                :class="{'border-red-500':errors.regular_price}">
                                
                                <p v-if="errors.regular_price" class="text-red-500"> {{ errors.regular_price[0] }} </p>
                            </div>
                            ...
                            <div class="flex flex-col w-full">
                                ...
                                <input type="text" v-model="discount_price" placeholder="discount price"
...
export default defineComponent({
  ...
  data(){
    ...
    setup: () => {
        ...
        const contentHTML = ref('<h1> Product descriptiono here </h1>')
        return { contentDelta, contentHTML}
    },
    methods:{
        createProduct(){
            axios.post('/api/admin/product/store',{
                ...
                week_sale: this.product.week_sale,
        ...
        storeSize(){
            axios.post('/api/admin/size/store',this.size)
            .then(res =>{
        ...
        reloadPage(){
            axios.get('/api/admin/product/create')
            .then(res=>{
    ...
    watch:{
        discount_price(value){
            ...
            let regularPrice = this.product.regular_price;
