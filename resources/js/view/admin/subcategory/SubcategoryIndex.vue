        ...
        <div class="max-w-full px-4 w-full my-6">
          	<div class="p-6 bg-white rounded-lg shadow-lg h-full my-4">
                <div class="flex flex-row justify-between items-center pb-2">
                    <router-link to="/admin/subcategory/index" class="px-4 py-1 uppercase bg-white text-green-800 border-2 border-green-800
                        transition duration-300 hover:bg-green-800 hover:text-white">
                        All subcatgories
                    </router-link>

                    <router-link to="/admin/subcetegory/trashed" class="px-4 py-1 uppercase text-red-800 border-2 border-red-800
            ...
            <div class="flex justify-center items-center">
                <div class="w-96 -ml-10 bg-white px-4 my-10">
                    ...
                    <form @submit.prevent="formCreate ? createSubCat() : updateSubCat()" class="w-full">
                        ...
                        <button type="submit" class="capitalize py-2 my-4 px-4 bg-indigo-800 text-white rounded-md transition duratuion-300 hover:bg-indigo-600"> {{ buttonText }} </button>
                    </form>
                </div>
            </div>
        </div>
        ...
        methods:{
            ...
            handleChange(e) {
                if(e.target.options.selectedIndex > -1) {
                    this.selectItem= e.target.options[e.target.options.selectedIndex].dataset.foo;
                }
            },
            createSubCat(){
                ...
                .then(res =>{
                    ...
                    console.log(this.category_id.text);
                })
                .catch(errors =>{
