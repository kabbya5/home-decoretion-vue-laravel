            ...
            <div class="grid grid-cols-4 gap-4">
                <div class="col-span-4 lg:col-span-3 bg-white border border-gray-200 my-5">
                                ...
                                <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                                    ...
                                    <div class="overflow-x-auto">
                                        ...
                                        <thead class="border-b text-left my-5">
                                            <tr>
                                                <th scope="col" class="text-sm font-medium text-gray-600 px-2 py-2 text-left">
                                                    Image
                                                </th>
                                                <th scope="col" class="text-sm font-medium text-gray-600 px-2 py-2 text-left">
                                                    Product Code
                                        ...
                                        <tbody class="bg-white">
                                                <tr v-for="detail in orderDetails" :key="detail.id" class="border-b">
                                                    <td class="px-2 py-2 whitespace-nowrap text-sm font-medium text-gray-600">
                                                        <div> 
                                                    ...
                                                    <td class="text-md text-gray-600 font-md px-2 py-2 whitespace-nowrap">
                                                        <div class="flex flex-col">
                                                            <router-link :to="{name:'product-detail',params:{slug:detail.product.slug}}">
                                                                <span class="text-md text-gray-600 font-md"> {{ detail.product.product_code }}</span>
                                                            </router-link> 
                                                        </div> 
                                                    </td>                             
                                                    <td class="text-sm text-gray-600 font-md px-2 py-2 whitespace-nowrap">
                                                        {{ detail.size}}
                                                    </td>
                                                    <td class="text-sm text-gray-600 font-md px-2 py-2 whitespace-nowrap">
                                                        {{ detail.color}}
                                                ...
                                                <tr>
                                                    <td v-if="order.coupon" colspan="5" align="right" class="py-2"> 
                                                        <span class="font-[500] text-gray-600 text-md">
                                                            {{ order.coupon }} Discount:
                                                         </span> 
                                                    </td>
                                                    <td v-if="order.coupon" colspan="3"> 
                                                        <span class="text-red-900 text-md pl-5 font-[500]">
                                                            {{order.discount}}  TK
                                                        </span>  
                                                    </td>   
                                                </tr>
                                                <tr class="mt-5">
                                                    ...
                                                    <td colspan="3"> 
                                                        <span class="text-red-900 text-md pl-5 font-[500]"> {{ order.subtotal }} Tk</span>
                                                    </td>
                                                </tr>
                                        </tbody>
                                        </table>
                    ...
                    <div class="my-5 md:my-10 py-5">
                        <h4 class="font-md text-xl text-center"> Customer And Order Details  </h4>
                       
                        <div class="flex justify-between items-center  border border-gray-200 mt-5">
                            <h4 class=" text-md py-2 px-2 font-md text-gray-600"> Customer Name: </h4>
                            <p v-if="shipping" class="mx-1  text-md py-2 px-2 font-md text-gray-600">{{ shipping.name }} </p>
                        </div>
                        <div class="flex justify-between items-center border border-gray-200 mt-5">
                            <h4 class=" text-md py-2 px-2 font-md text-gray-600"> Customer Phone: </h4>
                            <p v-if="shipping" class="mx-1  text-md py-2 px-2 font-md text-gray-600">{{ shipping.phone }}</p>
                        </div>
                        <div class="flex justify-between items-center border border-gray-200 mt-5">
                            <h4 class=" text-md py-2 px-2 font-md text-gray-600"> Customer Email: </h4>
                            <p v-if="shipping" class="mx-1  text-md py-2 px-2 font-md text-gray-600">{{ shipping.email }}</p>
                        </div>
                        <div class="flex justify-between items-center border border-gray-200 mt-5">
                            <h4 class="font-md text-gray-600 text-md py-2 px-2 font-md"> Customer Addresss: </h4>
                            <p v-if="shipping" class="mx-1 text-md py-2 px-2 font-md text-gray-600">{{ shipping.address }}</p>
                        </div>
                        <div class="flex justify-between items-center border border-gray-200 mt-5">
                            <h4 class=" text-md py-2 px-2 font-md text-gray-600"> Customer district: </h4>
                            <p v-if="shipping" class="mx-1  text-md py-2 px-2 font-md text-gray-600">{{ shipping.district}}</p>
                        </div>
                    </div>
                ...
                <div class="col-span-4 lg:col-span-1 my-5">
                    <div class="p-5 w-full bg-white">
                        <h4 class="font-[500] text-lg pb-4"> Order Details  </h4>
                    ...
                    <div class="my-3 p-5 w-full bg-white">
                        <h4 class="font-[500] text-lg text-gray-600 my-2"> Order Summary  </h4>
                        <div class="flex items-center border-gray-200">
                            <h4 class="font-md text-md py-2 px-2 font-md text-gray-600"> Created : </h4>
                            <p class="mx-1 font-md text-md py-2 px-2 font-md text-gray-600"> {{ order.created_date }} </p>
                        </div>
                        <div class="flex items-center border-gray-200">
                            <h4 class="font-md text-md py-2 px-2 font-md text-gray-600"> Time : </h4>
                            <p class="mx-1 font-md text-md py-2 px-2 font-md text-gray-600"> {{ order.created_time }} </p>
                        </div>
                        <div class="flex items-center border-gray-200">
                            <h4 class="font-md text-md py-2 px-2 font-md text-gray-600"> Payment: </h4>
                            <p class="mx-1 font-md text-md py-2 px-2 font-md text-gray-600"> {{ order.payment_type }} </p>
                        </div>  
                        <div class="flex items-center border-gray-200">
                            <h4 class="font-md text-md py-2 px-2 font-md text-gray-600"> Delivery: </h4>
                            <p class="mx-1 font-md text-md py-2 px-2 font-md text-gray-600"> {{ order.delivery_type }} </p>
                        </div>              
                    </div>
        
                    <div class="my-3 p-5 w-full bg-white">
                        <div class="flex items-center border-gray-200">
                            <h4 class="font-[500] text-lg text-gray-600 my-2 uppercase"> Subtotal : </h4>
                            <p class="font-[500] text-xl text-gray-600 my-2 px-4">{{ order.subtotal  }} TK</p>
                        </div>               
                    </div>
                    ...
                    <div class="my-3 p-5 w-full bg-white">
                        ...
                        <div class="flex items-center border-gray-200">
                            <p v-if="shipping" class="mx-1 font-md text-md py-2 px-2 font-md text-gray-600">{{ shipping.address }}</p>
                        </div>          
                    </div>
                    ...
                    <div class="my-3 p-5 w-full bg-white">
                        ...
                        <div class="flex items-center border-gray-200">
                            <p  v-if="shipping" class="mx-1 text-md py-2 px-2 font-md text-gray-600">{{ shipping.comment }}</p>
                        </div>            
                    </div>
